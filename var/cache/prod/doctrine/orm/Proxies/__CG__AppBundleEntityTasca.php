 ...
 */
class Tasca extends \AppBundle\Entity\Tasca implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Tasca' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Tasca' . "\0" . 'nom', '' . "\0" . 'AppBundle\\Entity\\Tasca' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Tasca' . "\0" . 'fechaInicio', '' . "\0" . 'AppBundle\\Entity\\Tasca' . "\0" . 'fechaFin'];
        }
