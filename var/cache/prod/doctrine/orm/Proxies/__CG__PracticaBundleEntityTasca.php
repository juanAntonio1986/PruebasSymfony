 ...
 */
class Tasca extends \PracticaBundle\Entity\Tasca implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PracticaBundle\\Entity\\Tasca' . "\0" . 'id', '' . "\0" . 'PracticaBundle\\Entity\\Tasca' . "\0" . 'nom', '' . "\0" . 'PracticaBundle\\Entity\\Tasca' . "\0" . 'descripcion', '' . "\0" . 'PracticaBundle\\Entity\\Tasca' . "\0" . 'fechaInicio', '' . "\0" . 'PracticaBundle\\Entity\\Tasca' . "\0" . 'fechaFin'];
        }
